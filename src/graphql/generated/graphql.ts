...
export type AddPokemonToTeamMutation = { addPokemonToTeam: { id: string, name: string, pokemons: Array<{ id: number, name: string }> | null } | null };
...
export type RemovePokemonFromTeamMutation = { removePokemonFromTeam: { id: string, name: string, pokemons: Array<{ id: number, name: string }> | null } | null };
...
export type FindTeamByIdQuery = { findTeamById: { id: string, name: string, trainer: { id: string, name: string }, pokemons: Array<{ id: number, name: string }> | null } | null };

export type MeQueryVariables = Exact<{ [key: string]: never; }>;


export type MeQuery = { me: { id: string, name: string, email: string, team: { id: string, name: string, pokemons: Array<{ id: number, name: string }> | null } | null } | null };
